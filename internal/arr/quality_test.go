...
func TestFilterMissing(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "monitored with no file included",
			items: []LibraryItem{
				{ID: 1, Label: "Missing A", HasFile: false, Monitored: true},
			},
			want: 1,
		},
		{
			name: "unmonitored with no file excluded",
			items: []LibraryItem{
				{ID: 1, Label: "Missing A", HasFile: false, Monitored: false},
			},
			want: 0,
		},
		{
			name: "has file excluded",
			items: []LibraryItem{
				{ID: 1, Label: "Has File", HasFile: true, Monitored: true},
			},
			want: 0,
		},
		{
		...
		},
		{
			name: "mixed items filtered correctly",
			items: []LibraryItem{
				{ID: 1, Label: "Missing monitored", HasFile: false, Monitored: true},
				{ID: 2, Label: "Missing unmonitored", HasFile: false, Monitored: false},
				{ID: 3, Label: "Has file monitored", HasFile: true, Monitored: true},
				{ID: 4, Label: "Missing monitored 2", HasFile: false, Monitored: true},
			},
			want: 2,
		},
	}

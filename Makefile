.PHONY: build run generate test test-cover lint vet fmt fmt-check prettier prettier-check tidy docker-build docker-up docker-down docker-logs migrate-up migrate-down migrate-status clean

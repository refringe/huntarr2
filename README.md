...
Huntarr2 tells your \*arr apps to search for quality upgrades so you don't have to do it manually.

It connects to Sonarr, Radarr, Lidarr, and Whisparr, finds items that haven't reached their quality cutoff, and triggers searches for them on a schedule. That's it. There is a web UI for configuration and viewing what it's doing.
...
3. Each tick, it checks your \*arr libraries for items below their quality cutoff.
4. It tells the \*arr app to search for upgrades on those items.
...
Huntarr2 does not download anything itself. It just tells your existing \*arr apps to look for better versions of what you already have.
